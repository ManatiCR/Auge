...
*/
?>
<div class="panel-display panel-display-margin panel-one-col-wmargin panel-grid-width <?php if (!empty($css_id)): print $css_id; endif; ?>>" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>
