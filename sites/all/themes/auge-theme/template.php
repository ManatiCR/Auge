 ...
 *
 */
function auge_preprocess_page(&$variables) {
 ...
 */
function auge_preprocess_html(&$variables) {
  $meta_charset = array(
    '#tag' => 'meta',
    '#attributes' => array(
      'charset' => 'utf-8',
  ...
  drupal_add_html_head($html5shiv, 'auge_theme_html5shiv');
  // ENDTODO
  ...
  drupal_add_html_head($respondjs, 'auge_theme_respondjs');
  // ENDTODO
 ...
 */
function auge_html_head_alter(&$head_elements) {
...
function auge_preprocess_node(&$vars) {
  // Add a striping class.
  $vars['classes_array'][] = 'node-' . $vars['zebra'];
}

function auge_preprocess_block(&$vars, $hook) {
  // Add a striping class.
